/* Autores: Abner, Allan e Elder.
   Versão: 1.2.
   Data: 25/07/2022.
   Descrição: Utilizar Vetores criar uma tabela via Java Script. */
...
function vetor() {
    ...
    // Utilização for dentro de for para criar Colunas e Linhas, cria corpo
    for (var linha = 0; linha < diaTotais; linha++) {
        ...
        for (var coluna = 0; coluna < horaTotais - 1; coluna++) {
